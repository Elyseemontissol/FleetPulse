...
export default function DashboardPage(): React.JSX.Element {
  ...
  const stats = [
    { name: 'Total Assets', value: totalAssets.toString(), icon: Car, color: 'text-blue-600 bg-blue-100' },
    { name: 'Active', value: activeCount.toString(), icon: CheckCircle, color: 'text-green-600 bg-green-100' },
    { name: 'In Shop', value: inShopCount.toString(), icon: Wrench, color: 'text-yellow-600 bg-yellow-100' },
    { name: 'Out of Service', value: oosCount.toString(), icon: XCircle, color: 'text-red-600 bg-red-100' },
  ];
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">{openWOs}</p>
              </div>
              <div className="rounded-lg bg-gray-50 p-4">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">${Math.round(fuelCost).toLocaleString()}</p>
              </div>
              <div className="rounded-lg bg-gray-50 p-4">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">{utilization}%</p>
              </div>
              <div className="rounded-lg bg-gray-50 p-4">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">{inShopCount}</p>
              </div>
            </div>
          </div>
